...
import com.privat.privatbankstack.exceptions.Errors;
import com.privat.privatbankstack.exceptions.OperationError;
    ...
    private KeyPair getKeyPair(String publicKeyPath, String privateKeyPath) {
        ...
        if (publicKeyFile.exists() && privateKeyFile.exists()) {
            try {
                ...
                throw new OperationError(e.getMessage());
            }
        } else {
            if (Arrays.asList(environment.getActiveProfiles()).contains("prod")) {
                throw new OperationError(Errors.PUBLIC_AND_PRIVATE_KEY_NOT_EXIST);
            }
        }
